    ...
    <div>
          ...
          <div className="row">
            <div className="align-self-center col col-12 col-md-6 text-left">
              <h2
                ...
                style={{ fontWeight: "600", lineHeight: "3rem" }}
              >
                Introducing The Future of NFTs: Smart NFTs
              </h2>
              <h6
                className="white"
                style={{ fontWeight: "400", lineHeight: "1.8rem" }}
              >
                Imagine a video game sword that gets stronger every time it is
                used to slay a monster. Smart NFTs have properties that can
                change based on certain conditions.
              </h6>
              <Button disabled className="mt-4 white" outline pill>
                Build on Altura
              </Button>
            </div>
            <div className="col col-12 col-md-6 p-5">
              <img
                alt="floating gaming sword"
                src="images/graphics/sword.gif"
      ...
      <div style={{ paddingTop: "100px", paddingBottom: "100px" }}>
        <div className="container">
          <h2
            className="blue"
            style={{ fontWeight: "800", marginBottom: "6rem" }}
          >
          ...
          <div className="row">
            <div className="col col-12 col-md-6 col-lg-4">
              <img
                alt="transparent files"
                style={{ maxWidth: "100px", maxHeight: "100px" }}
                src="images/graphics/transparent.svg"
              />
              <h4 className="mb-3 mt-3" style={{ fontWeight: "600" }}>
                Transparent Protocols
              </h4>
              <p>
                Altura uses Chainlink's VRF to provide a provably fair and
                tamper-proof source of randomness.
              </p>
            </div>

            <div className="col col-12 col-md-6 col-lg-4">
              <img
                alt="open network around gem"
                style={{ maxWidth: "100px", maxHeight: "100px" }}
                src="images/graphics/open.svg"
              />
              <h4 className="mb-3 mt-3" style={{ fontWeight: "600" }}>
                Open Source
              </h4>
            ...
            <div className="col col-12 col-md-6 col-lg-4">
              <img
                alt="shapes"
                style={{ maxWidth: "100px", maxHeight: "100px" }}
                src="images/graphics/simple.svg"
              />
              <h4 className="mb-3 mt-3" style={{ fontWeight: "600" }}>
                Simple APIs
              </h4>
            ...
            <div className="col col-12 col-md-6 col-lg-4">
              <img
                alt="deed"
                style={{ maxWidth: "100px", maxHeight: "100px" }}
                src="images/graphics/ownership.svg"
              />
              <h4 className="mb-3 mt-3" style={{ fontWeight: "600" }}>
                True Ownership
              </h4>
            ...
            <div className="col col-12 col-md-6 col-lg-4">
              <img
                alt="ven diagram with sword in middle"
                style={{ maxWidth: "100px", maxHeight: "100px" }}
                src="images/graphics/cross.svg"
              />
              <h4 className="mb-3 mt-3" style={{ fontWeight: "600" }}>
        ...
        <div className="container">
          <div className="row">
            <div className="col col-12 col-md-6 order-2 order-md-1 p-5">
              <img
                alt="loot box opening with gem inside"
                src="images/graphics/lootbox.gif"
                style={{ width: "100%", height: "100%" }}
              />
            </div>
            <div className="align-self-center col col-12 col-md-6 order-1 order-md-2 text-left text-md-right ">
              ...
              <Button
                target="_blank"
                href="https://medium.com/@alturanft/altura-integrating-chainlink-vrf-to-power-provably-random-loot-boxes-99e29d6f8e4"
          ...
          <div className="row">
            <div className="align-self-center col col-12 col-md-6 text-left">
              ...
              <h6 style={{ fontWeight: "400", lineHeight: "1.8rem" }}>
                Explore a whole world of in-game items through Altura's NFT
                marketplace. It is also the most powerful NFT minting platform.
              </h6>
              <Button
            ...
            <div className="col col-12 col-md-6 p-5">
              <img
                src="/images/graphics/marketplace.jpg"
                alt="Plotus Marketplace"
