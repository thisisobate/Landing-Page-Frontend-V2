      ...
      <div className="container text-left mt-5 pt-5 mb-5 pb-5">
        <div className="row justify-content-center">
          ...
          <h2>Website Terms of Use</h2>
            ...
            <p>The Alturs Marketplace website located at app.alturanft.com is a copyrighted work belonging to Altura NFT. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
            ...
            <p><strong>Cookies and Web Beacons.</strong> Like any other website, Alturs Marketplace uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p>
